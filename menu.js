$(document).ready(function () {
    ...
    function addToCart(item) {
        ...
        cartItems[item.id] = item; // Use item.id as the key
    ...
    $(".add").on("click", ".cart", function () {
        ...
        // Call addToCart to store the updated item in local storage
        addToCart({ id: ids, name: itemname, price: itemprice, quantity: cart[ids].quantity });
